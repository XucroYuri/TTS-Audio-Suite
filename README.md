...
| **⚙️ DramaBox Integration**                     | DramaBox expressive scene prompting with native SRT duration targeting | ✅ **New in v5.6** | [📁 JSON](example_workflows/DramaBox%20integration.json) · [🖼️ Cover](example_workflows/DramaBox%20integration.jpg) |
